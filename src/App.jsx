  ...
  return (
    <>
      ...
      <div className={`fixed w-full h-full z-20 pointer-events-none border-10rem border-white rounded-lg transition duration-500ms ${state === 'overlay' ? 'scale-100%' : 'scale-200%'}`}>
        ...
        {state === 'overlay' && (
          <>
            <motion.div className="text-xl absolute top-0 text-black z-10" initial={{ y: -500 }} animate={{ y: -100, transition: { type: "spring", duration: 1 } }}>
            ...
            <motion.div className="text-xl absolute bottom-0 text-black z-10" initial={{ y: 500 }} animate={{ y: 100, transition: { type: "spring", duration: 1 } }}>
      ...
      <div className="h-full">
        ...
        <div className="body">
          ...
          >
            ...
            />
            <div className="h-50px w-50px absolute top-6 left-6  rounded-full bg-black z--20">
            </div>
          </motion.div>
